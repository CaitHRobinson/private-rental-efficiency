## Clean and prepare EPC data

💬 **Language:** R

📌 **Section summary:** We analyse new property-scale Energy Performance Certificates (EPC). In this section we explain [how to clean and prepare the EPC variables](https://github.com/CaitHRobinson/private-rental-efficiency/blob/main/clean/clean-code.rmd) of interest, for an example region of the North East of England. 
