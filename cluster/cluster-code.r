...
colnames(data.original) <- c("OA21CD","LOCAL_AUTHORITY", "count_EPC",
                    ...
                    "count_hotwaterpoor","count_hotwaterverypoor", 
                    "count_wallspoor","count_wallsverypoor", 
                    "count_mainheatpoor", "count_mainheatverypoor",
                    "count_current_DandBelow", "count_potential_DandBelow", 
                    "count_current_FandBelow", "count_potential_FandBelow", 
